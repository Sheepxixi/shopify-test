...
示例：  
- 用户说「帮我优化一下这个提示词」 → 使用 prompt-optimizer-cn 进行精炼和结构化  
- 用户提出功能请求「添加用户登录功能」 → 使用 prompt-optimizer-cn 提取技术需求并结合相关代码上下文  
- 用户问「如何改进这个 API 调用提示」 → 使用 prompt-optimizer-cn 提升清晰度，并补充来自现有代码库的实现细节  
model: inherit  
color: orange  
---
